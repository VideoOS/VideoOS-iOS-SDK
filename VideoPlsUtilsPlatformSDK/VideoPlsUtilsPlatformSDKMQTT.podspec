...
Pod::Spec.new do |s|
  s.name             = 'VideoPlsUtilsPlatformSDKMQTT'
  s.version          = '1.0.0'
  s.summary          = 'A private Utils Platform framework for VideoPls Persistent Connection.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
                        A private Utils Platform framework for VideoPls.Including Persistent Connection
                       DESC
  ...
  s.public_header_files = [
    'VideoPlsUtilsPlatformSDK/VideoPlsUtilsPlatformSDK/Subspec/MQTT/*.h'
  ]
