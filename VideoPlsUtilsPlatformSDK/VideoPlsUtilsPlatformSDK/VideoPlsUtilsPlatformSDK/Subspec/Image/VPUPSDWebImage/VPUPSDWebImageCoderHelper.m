...
@implementation VPUPSDWebImageCoderHelper

+ (UIImage *)animatedImageWithFrames:(NSArray<VPUPSDWebImageFrame *> *)frames {
    ...
    [frames enumerateObjectsUsingBlock:^(VPUPSDWebImageFrame * _Nonnull frame, NSUInteger idx, BOOL * _Nonnull stop) {
...
+ (NSArray<VPUPSDWebImageFrame *> *)framesFromAnimatedImage:(UIImage *)animatedImage {
    if (!animatedImage) {
        return nil;
    }
    ...
    [animatedImages enumerateObjectsUsingBlock:^(UIImage * _Nonnull image, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([image isEqual:previousImage]) {
            ...
            VPUPSDWebImageFrame *frame = [VPUPSDWebImageFrame frameWithImage:previousImage duration:avgDuration * repeatCount];
    ...
    for (size_t i = 0; i < frameCount; i++) {
        @autoreleasepool {
            ...
            VPUPSDWebImageFrame *frame = [VPUPSDWebImageFrame frameWithImage:frameImage duration:frameDuration];
            [frames addObject:frame];
        }
    }
#endif
