...
/**
 ...
 Coders
 ------
 A coder must conform to the `VPUPSDWebImageCoder` protocol or even to `VPUPSDWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@interface VPUPSDWebImageCodersManager : NSObject<VPUPSDWebImageCoder>
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<VPUPSDWebImageCoder>* coders;
