 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const VPUPSDWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull VPUPSDCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL VPUPSDCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol VPUPSDWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {VPUPSDWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
...
/**
 ...
 @param format The image format to encode, you should note `VPUPSDImageFormatUndefined` format is also  possible
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(VPUPSDImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol VPUPSDWebImageProgressiveCoder <VPUPSDWebImageCoder>
