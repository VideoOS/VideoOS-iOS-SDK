...
@interface VPUPSDWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<VPUPSDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<VPUPSDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
