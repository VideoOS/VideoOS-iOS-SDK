...
#import "UIImageView+VPUPFillColor.h"
...
@implementation UIImageView (VPUPFillColor)
...
- (void)vpup_fillImageWithColor:(UIColor *)color {
    ...
    imageMaskLayer.contents = (__bridge id __nullable)(self.image.CGImage);
