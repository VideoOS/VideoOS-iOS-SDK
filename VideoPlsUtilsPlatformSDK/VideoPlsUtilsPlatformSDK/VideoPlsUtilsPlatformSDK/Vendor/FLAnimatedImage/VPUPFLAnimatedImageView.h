...
@class VPUPFLAnimatedImage;
@protocol VPUPFLAnimatedImageViewDebugDelegate;
...
//
@interface VPUPFLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) VPUPFLAnimatedImage *animatedImage;
