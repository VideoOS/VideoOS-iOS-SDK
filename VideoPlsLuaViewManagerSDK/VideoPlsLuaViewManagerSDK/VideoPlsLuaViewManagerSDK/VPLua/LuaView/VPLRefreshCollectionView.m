...
@interface VPLRefreshCollectionView()

//@property (nonatomic, strong) UIActivityIndicatorView *indicatorView;

@end

@implementation VPLRefreshCollectionView

#pragma mark -- LVRefreshHeader api

- (void)lv_initRefreshHeader {// 初始化下拉刷新功能
    VPLNormalRefreshHeader* refreshHeader = [[VPLNormalRefreshHeader alloc] init];
